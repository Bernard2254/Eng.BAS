    ...
    if(Player2.bebado>=50 || Player1.bebado>=50){
      ...
      /*TelaVencedor=1;
        if(Player1.bebado>=50){
          if(Player1.textura==texturaCefet1 || Player1.textura==texturaCefet2 || Player1.textura==texturaCefet3 || Player1.textura==texturaCefet4)
            colocaTextoBotao(texturaZoaCefet,0.5*dimensaox,0.5*dimensaoy,50,20);
          else if(Player1.textura==texturaPuc1 || Player1.textura==texturaPuc2 || Player1.textura==texturaPuc3 || Player1.textura==texturaPuc4)
            colocaTextoBotao(texturaZoaPuc,0.5*dimensaox,0.5*dimensaoy,50,20);
          else if(Player1.textura==texturaUfop1 || Player1.textura==texturaUfop2 || Player1.textura==texturaUfop3 || Player1.textura==texturaUfop4)
          ...
          if(Player2.textura==texturaCefet1 || Player2.textura==texturaCefet2 || Player2.textura==texturaCefet3 || Player2.textura==texturaCefet4)
            colocaTextoBotao(texturaZoaCefet,0.5*dimensaox,0.5*dimensaoy,50,20);
          else if(Player2.textura==texturaPuc1 || Player2.textura==texturaPuc2 || Player2.textura==texturaPuc3 || Player2.textura==texturaPuc4)
            colocaTextoBotao(texturaZoaPuc,0.5*dimensaox,0.5*dimensaoy,50,20);
          else if(Player2.textura==texturaUfop1 || Player2.textura==texturaUfop2 || Player2.textura==texturaUfop3 || Player2.textura==texturaUfop4)
            colocaTextoBotao(texturaZoaUFOP,0.5*dimensaox,0.5*dimensaoy,50,20);
...
int y;
  switch (global) {
    ...
    break;
    case 8:
    if(TelaSeta==0 && TelaProjetil==0 && TelaForca==0 && TelaAndando==1 && TelaVencedor==0){
      if(PlayerMomento%2==0)
    ...
    else if(TelaSeta==1 && TelaPause==0 && TelaSair==0 && TelaReiniciar==0 || TelaForca==1 && TelaVencedor==0){
    ...
    if(define==-1 && DoisJogadores==0 && TelaVencedor==0){
      velocidadey=-sin((angle*pi)/180)*velocidade;
      velocidadex=-cos((angle*pi)/180)*velocidade;
      Projetil.posx=PlayerJogando.posx;
      Projetil.posy=PlayerJogando.posy+0.13*dimensaoy;
    ...
    else if(TelaProjetil==1 && TelaPause==0 && TelaSair==0 && TelaReiniciar==0 && TelaVencedor==0){
      colocaTextoBotao(texturaFundoJogo,0.5*dimensaox,0.5*dimensaoy,dimensaox/2,dimensaoy/2);
      colocaPlayer(Player1.textura, Player1.posx, Player1.direcao);
      colocaPlayer(Player2.textura, Player2.posx, Player2.direcao);
      glPushMatrix();
      ...
      if(PlayerJogando.posx==Player1.posx){
        ...
        if(Projetil.posy>=Player2.posy-0.09*dimensaoy && Projetil.posy<=Player2.posy+0.12*dimensaoy){
          ...
          if(Projetil.textura==texturaCerveja)
            ...
            Player2.bebado=Player2.bebado+(rand()%3+5);
        //  printf("Player Bebado = %d\n", Player2.bebado);
        }
      }
      }
        ...
        if(Projetil.posy>=Player1.posy-0.09*dimensaoy && Projetil.posy<=Player1.posy+0.12*dimensaoy){
          ...
          if(Projetil.textura==texturaCerveja)
            ...
            Player1.bebado=Player1.bebado+(rand()%3+5);
        }
      }
      }
  ...
  if(PlayerMomento%2==1 && DoisJogadores==0){
	...
	//printf("erro = %d\n", PlayerJogando.bebado%loucura);
      ...
      for(teste1=1,s1=Projetil.posx, s2=Projetil.posy; teste1<200 ;teste1=teste1+0.05){
        ...
        if(s1<=Player1.posx+1 && s1>=Player1.posx-1 && s2<=Player1.posy+6 && s2>=Player1.posy-1.5){
          TelaProjetil=1;
          TelaForca=0;
      ...
      cont++;
      if(forca>=0.17 && TelaProjetil==0 && cont>100){
        TelaProjetil=1;
        TelaForca=0;
        cont=0;
        glutTimerFunc(100,animacaoTaca,1);
