...
int global,b, c, QUANTIDADE_PLAYERS,cont, TelaSair=0,k=0, TelaReiniciar=0, TelaPause=0, inicio=0, soma=0, TelaForca=0, compensa, loucura, t;
...
texturaUfop1, texturaUfop2, texturaUfop3, texturaUfop4, texturaCerveja, texturaCachaca, texturaVomito1, texturaVomito2,
texturaVomito3, texturaJogarNovamente,
